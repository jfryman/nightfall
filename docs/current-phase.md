...
- Phase 4.2 completed 2026-06-04 by PR pending: QuickDraw rectangle drawing and
...
Execute Phase 4.3: QuickDraw line and pen-state operations.
...
- Golden and scanline state assertions.
- Validation log at `docs/phase-4.3-validation.md`.
